...
bin/mkdir : build/ArgumentCollection.o build/HelpMessage.o build/FileOperations.o build/TextOperations.o build/FileReader.o build/FileCreator.o build/FileStat.o
	g++ ${CPPFLAGS} $(INC) -c src/mkdir.cpp -o build/mkdir.o
	g++ ${CPPFLAGS} -o bin/mkdir build/mkdir.o build/ArgumentCollection.o build/HelpMessage.o build/FileOperations.o build/TextOperations.o build/FileReader.o build/FileCreator.o build/FileStat.o
